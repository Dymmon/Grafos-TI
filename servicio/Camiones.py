...
def crear_ruta(camion,centros,puntos):
    ...
    orden.append("punto de venta " + str(buscar_id(puntos,mas_cercano(camion.centro_dist,recorridos,camion.ptos_venta))))
    while( len(recorridos)< len(camion.ptos_venta)):
        orden.append("Punto de venta " + str(buscar_id(puntos,mas_cercano(recorridos[len(recorridos)-1],recorridos,camion.ptos_venta))))
